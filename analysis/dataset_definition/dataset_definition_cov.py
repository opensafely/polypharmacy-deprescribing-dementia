...
from ehrql.tables.tpp import clinical_events, practice_registrations,ons_deaths, patients
...
for year in range(2017, 2025):
    ...
    #Frailty variables
    add_frailty_variables(dataset, date(year, 1, 1), year)
