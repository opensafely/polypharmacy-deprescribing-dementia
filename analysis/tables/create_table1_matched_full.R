...
df <- readr::read_rds(here("output", "dataset_clean", "input_clean_matched_full.rds"))
...
write_csv(df, here("output", "tables", "table1_matched_full.csv"))
...
write_csv(df, here("output", "tables", "table1_matched_full_midpoint6.csv"))
